...
const BtnCircle = ({ className, icon, click }) => {
	return (
        ...
        >
            ...
            {
                icon === 'plus' &&
                    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 491.86 491.86" style={{enableBackground: 'new 0 0 491.86 491.86'}} xmlSpace="preserve" width="512px" height="512px">
                    	<g>
